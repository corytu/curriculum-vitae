...
- **Data Engineer & Project Manager** (Mar 2020 - Feb 2021)
  ...
  - Coordinated Data, Backend, Business Development, and Product teams' resources to a) onboard more than 25 clinical labs and 120 clinics in Taiwan and collect lab test results from them, and b) refine the ETL data pipeline with MongoDB and Apache Kafka for both app products and data analyses, making it scalable worldwide
    - Parsed and cleansed real-world data from electronic medical records or uploaded files for following data analyses or product applications
    - Be the liaison for data transfers between Health2Sync and third parties with BD managers
    - Designed database schema and pipeline architecture with backend engineers
    - Identified data issues and reported them to third parties or BD managers for clarification
    - Plotted progress timeline for the whole project
